...
#用于爬取新浪财务的网页
urls2=['http://finance.sina.com.cn/roll/index.d.html?cid=56952&page=1','http://finance.sina.com.cn/roll/index.d.html?cid=56952&page=2','http://finance.sina.com.cn/roll/index.d.html?cid=56952&page=3','http://finance.sina.com.cn/roll/index.d.html?cid=56952&page=4','http://finance.sina.com.cn/roll/index.d.html?cid=56952&page=5','http://finance.sina.com.cn/roll/index.d.html?cid=56952&page=6']
    ...
    for url in urls2:
        ...
        for i in res:
            try:
                ...
                nodeTopic.appendChild(doc.createTextNode('finance'))
                ...
                break
scrap()
fp=open('/Users/tianyu/news2.xml','w')
